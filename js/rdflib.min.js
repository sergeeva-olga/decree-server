...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),ClassOrder=require("./class-order"),Node=require("./node"),NamedNode=function(e){function t(e){_classCallCheck(this,t);var r=_possibleConstructorReturn(this,Object.getPrototypeOf(t).call(this));return r.termType=t.termType,e.indexOf(":")<0&&console.log('Warning: NamedNode IRI "'+e+'" must be absolute. Relative URIs will fail in future versions'),r.value=e,r}return _inherits(t,e),_createClass(t,[{key:"dir",value:function(){var e=this.uri.split("#")[0],r=e.slice(0,-1).lastIndexOf("/"),n=e.indexOf("//");return n>=0&&n+2>r||0>r?null:new t(e.slice(0,r+1))}},{key:"site",value:function(){var e=this.uri.split("#")[0],r=e.indexOf("//");if(0>r)throw new Error("This URI does not have a web site part (origin)");var n=e.indexOf("/",r+2);if(0>n)throw new Error("This URI does not have a web site part. (origin)");return new t(e.slice(0,n+1))}},{key:"doc",value:function(){return this.uri.indexOf("#")<0?this:new t(this.uri.split("#")[0])}},{key:"toString",value:function(){return"<"+this.uri+">"}},{key:"uri",get:function(){return this.value},set:function(e){this.value=e}}],[{key:"fromValue",value:function(e){if("undefined"==typeof e||null===e)return e;var r=e&&e.termType;return r?e:new t(e)}}]),t}(Node);NamedNode.termType="NamedNode",NamedNode.prototype.classOrder=ClassOrder.NamedNode,NamedNode.prototype.isVar=0,module.exports=NamedNode;
